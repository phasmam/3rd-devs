...
import type { AllowedDomain, Query, SearchResult, WebContent } from '../types/types';
...
export class WebSearchService {
  ...
  constructor() {
    ...
    this.allowedDomains = [
      ...
      { name: 'Hacker News Newest', url: 'https://news.ycombinator.com/newest', scrappable: true },
      { name: 'TechCrunch Latest', url: 'https://techcrunch.com/latest', scrappable: true },
